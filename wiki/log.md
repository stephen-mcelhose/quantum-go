...
## [2026-08-09] lint | 36 pages checked, 4 issues found, 4 fixed — (1) verification-tests: removed duplicate GetProbability note, corrected cross-ref from simulation-engine → state-vector-model; (2) testing-strategy: corrected false simulation-engine cross-ref → state-vector-model; (3) quantum-concepts: added missing [[gate-zoo]] link at gate table section
## [2026-08-09] fix | #12 rotation-gates: added [[rotation-gates]] to universality, qft-deep-dive, rotation-implementations, shors-algorithm, quantum-thermodynamics — π 0.000727→cleared, entropy 2.1339→2.1625
## [2026-08-09] fix | #13 error-correction: added [[error-correction]] to gate-implementations, scaling-and-limits, shors-algorithm, teleportation — π 0.003992→cleared; edges 183→192
